  ...
  return (
    <section id="about" className="section relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-40 right-50 w-96 h-96 bg-[#A7D8FF]/20 rounded-full blur-3xl" />
        <div className="absolute bottom-20 left-0 w-80 h-80 bg-[#5CB8FF]/10 rounded-full blur-3xl" />
      </div>
